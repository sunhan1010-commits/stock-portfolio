...
**포트폴리오 분석** — 배분·집중도·트리맵·리스크·상관관계를 한 화면에
![포트폴리오 분석](docs/analysis.png)

**종목 차트 + 기술적 지표** — 볼린저밴드·이동평균·RSI, 확대/축소 지원
![종목 차트](docs/chart.png)

**시장지표 대시보드** — 지수와 주요 원자재를 한눈에
![시장지표](docs/market.png)
